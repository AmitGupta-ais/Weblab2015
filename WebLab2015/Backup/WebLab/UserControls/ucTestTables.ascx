...
<table style="width: 100%; height: 100%">
    ...
    <tr>
        <td style="width: 100%; height: 94%; vertical-align: top; text-align: left;">
            ...
            <AIS:AisLabel ID="AisLabel1" runat="server" Visible="True">* Marked reports are under process, Not available now.</AIS:AisLabel>
            
            <AIS:AisLabel ID="lblInfo" runat="server" Visible="False">There is no data.</AIS:AisLabel>
            &nbsp;
