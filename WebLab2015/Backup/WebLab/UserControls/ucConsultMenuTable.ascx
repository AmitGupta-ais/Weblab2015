...
<AIS:AisLabel runat="server" ID="lblFromDT">From Date </AIS:AisLabel>
</td>
...
<td style="vertical-align: top; text-align: left; width: 15%;">
<AIS:AisLabel runat="server" ID="lblToDT">To Date</AIS:AisLabel>
</td>
...
<td style="vertical-align: top; text-align: left; width: 19%;">  
    ...
    <tr>
       <td style="width: 100%; height: 94%; vertical-align: top; text-align: left;">
           ...
           <AIS:AisLabel ID="lblInfo" runat="server" Visible="False">There is no data.</AIS:AisLabel></td>
     </tr>
