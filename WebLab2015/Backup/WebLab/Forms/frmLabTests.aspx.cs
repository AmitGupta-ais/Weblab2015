...
namespace WebLab.Forms
{
    public partial class frmLabTests : System.Web.UI.Page
    {
      ...
      //  DbConnection conn = Common.GetConnection("WebLabDetails");
                        ...
                        if(dt1.Rows.Count>0)
                        {
                            foreach(DataRow dr in dt1.Rows)
                            {
                                ...
                                if (Common.MyCStr(dr["ispf"]).Trim().ToUpper() == "N" && Common.MyCDbl(dr["hideinDuplicate"]) == 0)
                                {
                                       ...
                                       /////// ASD.LBND = getLowerBound(ASD.fldName, sex, age, mon, day, HBOUND,"" , ASD.KitCode);
                                        ASD.lcode = Common.MyCStr(dr["lcode"]);
                                        ASD.UBND = HBOUND;
                                       // ASD.unit = GetUnits(Common.MyCStr(ASD.KITCODE), strcode, Common.MyCStr(dr["units"]));
        ...
        //            pindex = pindex + 1
        //            load Combo1(pindex)
        //            Set ldcnt.CURRENTCONTROL = Combo1(pindex)
        ...
        //                    .enabled = True
        //                End If
        //                If Len(Trim(ldcnt.Option1)) > 0 Then
        //                    .addItem ldcnt.Option1
        //                End If

        //                If Len(Trim(ldcnt.Option2)) > 0 Then
        //                    .addItem ldcnt.Option2
        //                End If

        //                If Len(Trim(ldcnt.Option3)) > 0 Then
        //                    .addItem ldcnt.Option3
        //                End If

        //                If Len(Trim(ldcnt.Option4)) > 0 Then
        //                    .addItem ldcnt.Option4
        //                End If

        //                If Len(Trim(ldcnt.Option5)) > 0 Then
        //                    .addItem ldcnt.Option5
        //                End If
                        
        //                Dim RSOPT As ADODB.Recordset
        //                Set RSOPT = New ADODB.Recordset
        //                RSOPT.Open "SELECT * FROM TESTLINT WHERE CODE='" & replapwithap(ldcnt.FLDNAME) & "'", conn, adOpenStatic, adLockReadOnly

        //                Do While Not RSOPT.EOF
                            
        //                    .addItem (mycstr(RSOPT!OPTIONID))
        //                    RSOPT.MoveNext
        //                Loop
        ...
        //            End If
               ...
               /// ''''''''''''''''''''for multiline Textbox
                ...
                case "T":
                    ...
                    txt.Attributes.Add("style", "float:left;width:90%;");
                    ...
                    ucComment.controlval = convertFromRtfToHtml(ldcnt.comments);
                    ...
                    tindex = tindex + 1;
                    //load Text1(tindex)
                    //Set ldcnt.CURRENTCONTROL = Text1(tindex)
                ...
                case "Q":
                    ...
                    btnedit1.Text = "Table";
                    btnedit1.Attributes.Add("onclick", "showCommentModal('" + "uctable_" + tindex + "_htmlboxmodal" + "','uctable_" + tindex + "_close_" + tindex + "',''," + timeindex + ")");
                    //btnedit.OnClientClick = "";
                    cntcell.Controls.Add(btnedit1);
                    tr.Cells.Add(cntcell);
                    Image img1 = new Image();
                    img1.ID = "close_" + tindex;
                    img1.Attributes.Add("src", "../Images/closebtn.png");
                    img1.Attributes.Add("onclick", "closeModal('" + "uctable_" + tindex + "_htmlboxmodal" + "',this.id)");
                    img1.Attributes.Add("style", "position:fixed;z-index:1050;height:50px;width:50px;display:none;cursor:pointer;right:50%;top:0;background-color:white;border:4px white solid;border-radius:50%;");
                   ...
                   // uc2.controlval = ldcnt.CURRVAL;
                    ...
                    case "U" :
                        ...
                        btntabular.Attributes.Add("onclick", "showCommentModal('" + "uctabular_" + tindex + "_htmlboxmodal" + "','uctabular_" + tindex + "_close_" + tindex + "',''," + timeindex + ")");
                        cntcell.Controls.Add(btntabular);
                        tr.Cells.Add(cntcell);
                        Image img2 = new Image();
                        img2.ID = "close_" + tindex;
                        img2.Attributes.Add("src", "../Images/closebtn.png");
                        img2.Attributes.Add("onclick", "closeModal('" + "uctabular_" + tindex + "_htmlboxmodal" + "',this.id)");
                        img2.Attributes.Add("style", "position:fixed;z-index:1050;height:50px;width:50px;display:none;cursor:pointer;right:50%;top:0;background-color:white;border:4px white solid;border-radius:50%;");
        ...
        {     
            ...
            try
            {
                ...
                foreach (var item in lt)
                {
                    ...
                    coll.Add("comments", item.comment);
        ...
        public string convertFromRtfToHtml(string rtfstring)
        {
            string htmlstring=string.Empty;
               ...
               // string rtfFile = Path.GetFullPath(@"..\..\..\..\..\test.rtf");
                ...
                if (i == 0)
                {
                   ...
                   // htmlstring=r.ConvertFileToString(htmlFile);
                }
                else
                {
