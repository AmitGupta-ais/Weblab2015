...
<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css"
    rel="stylesheet" type="text/css" />
<script>
    function DownloadAtt(labno) {
        var labn = document.getElementById('hdlabno');
        labn.value = labno;
...
<table style="width: 100%; height: 100%">
    ...
    <tr>
        <td style="width: 100%; height: 94%; vertical-align: top; text-align: left;">
            <asp:GridView ID="GV1" runat="server" AllowSorting="True" BorderStyle="None"
                ...
                OnPageIndexChanging="GV1_PageIndexChanging" onRowDataBound="OnRowDataBound">
                ...
                <Columns>
                  ...
                  <%--  <asp:HyperLinkField DataTextField="LabNo" Text="Attachments"  NavigateUrl="~/Forms/frmTestTable.aspx"
                        DataNavigateUrlFields="LabNo,TestHeadCode,IsApp,IsOPDCreditBal" DataNavigateUrlFormatString="~/Forms/frmLabWiseAttachments.aspx?TestHeadCode={1}&LabNo={0}&IsApp={2}&IsOPDCreditBal={3}"
                        HeaderText="Attachments" Target="_blank" />--%>
                    <asp:HyperLinkField  DataTextField="LabNo" Text="View Attachments"  NavigateUrl="~/Forms/frmLabWiseAttachments.aspx" DataNavigateUrlFields="LabNo"
    ...
    <asp:HiddenField ClientIDMode="Static" runat="server" ID="hdlabno" Value="" />
    <asp:Button runat="server" ClientIDMode="Static" ID="btnsubmit" OnClick="dwnld_Click" style="display:none" />
</table>
