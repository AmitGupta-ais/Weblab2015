...
namespace WebLab {
    ...
    public class Culture : ReportClass {
    ...
    public class CachedCulture : Component, ICachedReport {
        
        public CachedCulture() {
        }
