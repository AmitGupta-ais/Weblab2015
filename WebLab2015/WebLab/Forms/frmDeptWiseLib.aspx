<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Menu.Master" AutoEventWireup="true" CodeBehind="frmDeptWiseLib.aspx.cs" Inherits="WebLab.Forms.frmDeptWiseLib" ClientIDMode="Static" %>
...
<link href="../Styles/UI.1.8.11.css" rel="stylesheet" type="text/css" />
    ...
    <script>
        ...
        function OpenTest(apCode,Dept,Code) {
            debugger
            var WinSettings = "left = 20, top = 20, width = 880, height = 600, toolbar = 1, resizable = 1, scrollbars = 1"
            window.open("../Forms/frmTestDetails.aspx?apCode=" + apCode+"&Dept="+Dept+"&Code="+Code+"&MODE=0");
        }
        ...
        function refresh() {
            ...
            $(function () {
                ...
                debugger;
                $.ajax({
                    url: 'frmDeptWiseLib.aspx?Dept=' + Dept,
                    success: function (data) {
                        debugger;
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="row">
            <div class="col-lg-12 sidelist">
                <div class="input-group"><label class="input-group-addon">Department</label>
