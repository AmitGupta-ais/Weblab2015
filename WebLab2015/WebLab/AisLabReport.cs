...
namespace WebLab {
    ...
    public class AisLabReport : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebLab.AisLabReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAisLabReport : Component, ICachedReport {
        
        public CachedAisLabReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AisLabReport rpt = new AisLabReport();
            rpt.Site = this.Site;
            return rpt;
        }
