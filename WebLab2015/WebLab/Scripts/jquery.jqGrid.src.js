	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				pgl += "<td id='"+po[0]+"' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-fast-backward'></span></td>";
				...
				pgl += "<td id='"+po[3]+"' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-fast-forward'></span></td>";
